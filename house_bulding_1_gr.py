...
build_house(base_x = 0, base_y = -100, base_width = 200, base_height = 10, base_fill = "#660000", walls_height = 150, walls_fill = "#FF9999", roof_height = 20, roof_fill = "green", door_fill = "#000000")
